...
\hi{Properties of Matrix Operations}
  ...
  \hii{Properties of Scalar Multiplication}
    \hiii{Commutative Rule}
      \[
  ...
  \hii{Properties of Matrix Multiplication}
    \hiii{Associative Rule}
      \[
  ...
  \hii{Properties of the Transpose of a Matrix}
...
\hi{Determinant of Square Matrix}
  ...
  \hii{Properties of Determinant}
    ...
    \hiii{Determinang and Rank Relationship}
      \begin{align*}
...
\hi{Inverse of a Square Matrix}
  ...
  \hii{Calculating the Inverse Matrix}
    \hiii{Method 1}
      \[
  ...
  \hii{Properties of Invertible Matrix}
