...
\hi{Distributions}
  ...
  \hii{Joint Distribution}
    \hiii{Joint Probability Mass Function}
      \[
        f(u, v) = P(X = u, Y = v)
      \]
    \hiii{Marginal Probability Mass Function}
      \[
        f_x(u) = P(X = u) \qquad f_y(v) = P(Y = v)
      \]
    \hiii{Mean, Variance and Covariance}
      \[
        E(X + Y) = E(X) + E(Y)
      \]
      \[
...
\begin{multicols}{2}
  \hii{Appendix: Integral Formulas}
    \begin{itemize}
