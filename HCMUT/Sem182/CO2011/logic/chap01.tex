...
\hi{Natural Deduction}
  ...
  \hii{Rules for Natural Deduction}
    \hiii{Rules for Conjunction (AND)}

      \begin{enumerate}[a.]
        \item \tb{Introduction Rule} is denoted by $\land i$.
          \begin{center}
            \AxiomC{$\phi$}
            \AxiomC{$\psi$}
            \RightLabel{$\land i$}
        ...
        \item \tb{Elimination Rule} is denoted by $\land e$.
          \begin{center}
            \AxiomC{$\phi \land \psi$}
            \RightLabel{$\land e_1$}
            \UnaryInfC{$\phi$}
    ...
    \hiii{Rules for Double Negation}
    ...
    \hiii{Rules for Implication}
      \begin{enumerate}[a.]
        \item \tb{Elimination Rule}, also known as \tb{modus ponens}, is denoted by $\limpl e$. Another related well-known rule is modus tollens, mentioned in the Derived Rules part.
          \begin{center}
            \AxiomC{$\phi$}
        ...
        \item \tb{Introduction Rule} is denoted by $\limpl i$.
          \begin{center}
            \alwaysNoLine
            \AxiomC{$\phi$}
            % \noLine
  ...
  \hii{Provable Equivalence}
    \par Let $\phi$ and $\psi$ be formulas of propositional logic. We say
